...
/// - note: If you decide to auto-inject either header or footer then the codegen won't generate functions that would allow you to pass them manually to prevent developers from
